...
//		label.setIcon(new ImageIcon("H:\\logo.png"));
		...
		public void keyPressed(KeyEvent e) {
			...
			if (e.getSource() == jtfpPrice) {
				...
				if (onlyNumbers == false && specialkeys == false) {
					JOptionPane.showMessageDialog(null, "You must enter digits only($0.00)", "Error", JOptionPane.ERROR_MESSAGE);
					jtfpPrice.setText("");
				}
				...
				specialkeys = datacheck.specialkeys((int) e.getKeyChar());
				if (onlyNumbers == false && specialkeys == false) {
					JOptionPane.showMessageDialog(null, "You must enter a quantity value", "Error", JOptionPane.ERROR_MESSAGE);
